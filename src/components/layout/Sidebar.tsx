...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange, isCollapsed, onToggle, alertCount = 0 }) => {
  ...
  const navigationItems = [
    ...
    { id: "components", icon: Settings, label: "Components", section: t('navigation.operations') },
    { id: "mileage", icon: Activity, label: "Mileage Logs", section: t('navigation.operations') },
    { id: "profile", icon: User, label: "Profile", section: t('navigation.administration') },
